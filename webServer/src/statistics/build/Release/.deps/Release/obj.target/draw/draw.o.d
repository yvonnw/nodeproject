cmd_Release/obj.target/draw/draw.o := g++ '-DNODE_GYP_MODULE_NAME=draw' '-DUSING_UV_SHARED=1' '-DUSING_V8_SHARED=1' '-DV8_DEPRECATION_WARNINGS=1' '-D_LARGEFILE_SOURCE' '-D_FILE_OFFSET_BITS=64' '-DBUILDING_NODE_EXTENSION' -I/home/yv/.node-gyp/8.6.0/include/node -I/home/yv/.node-gyp/8.6.0/src -I/home/yv/.node-gyp/8.6.0/deps/uv/include -I/home/yv/.node-gyp/8.6.0/deps/v8/include -I../-I/usr/include/python2.7/pyconfig.h -I/usr/include/python2.7 -I/usr/include/x86_64-linux-gnu/python2.7  -fno-strict-aliasing -Wdate-time -D_FORTIFY_SOURCE=2 -g -fstack-protector-strong -Wformat -Werror=format-security  -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes  -fPIC -pthread -Wall -Wextra -Wno-unused-parameter -m64 -O3 -fno-omit-frame-pointer -fno-rtti -fno-exceptions -std=gnu++0x -MMD -MF ./Release/.deps/Release/obj.target/draw/draw.o.d.raw   -c -o Release/obj.target/draw/draw.o ../draw.cc
Release/obj.target/draw/draw.o: ../draw.cc \
 ...
 /usr/include/python2.7/dtoa.h /usr/include/python2.7/pyfpe.h .././draw.h
../draw.cc:
